...
@section('titulo', 'Nuestros Docente')

@section('contenido')
<div class="card-header">
        <span class="display-4 card-title">Lista de Docente</span>
    </div>
    <a href="/docente/create" class="m-3 btn btn-dark">Crear Docente Nuevo</a>
    <div class="row">
