        ...
        <div class="row">
            <div class="col-6">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="idPaisExp" id="idPaisExp" value="{{$datoestudiante->idPaisExp}}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="idDepExp" id="idDepExp" value="{{$datoestudiante->idDepExp}}">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select class="form-control" name="idMuniExp" id="idMuniExp" value="{{$datoestudiante->idMuniExp}}">
                ...
                <div class="form-group">
                    ...
                    <input id="fechaExp" class="form-control" type="date" name="fechaExp" value="{{$datoestudiante->fechaExp}}">
                </div>
                <div class="form-group">
