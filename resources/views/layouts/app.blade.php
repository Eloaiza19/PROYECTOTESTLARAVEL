            ...
            <div class="container-fluid">
              ...
              <div id="my-nav" class="collapse navbar-collapse">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item ">
                            <a class="nav-link fs-3 text-dark" href="/curso/create">Curso <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link fs-3 text-dark" href="/docente">Docente <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item ">
