...
class EstudianteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('estudiante.index', compact('datoestudiante'));
    }
    ...
    public function create()
    {
        ...
        $datos = Curso::all();
        return view('estudiante.create', compact('paises','departamentos', 'municipios', 'datos'));
        // return $paises;
    }
    ...
    {
        $datoestudiante = new Estudiante();//Lo eque hicimos fue crear una instancia de la clase Curso
    ...
    public function show($id)
    {
        ...
        $query2 = Municipio::join(
            'estudiante', 'estudiante.idMuni', 'municipios.id'
        )
        ->join('departamentos', 'departamentos.id', 'municipios.idDep')
        ->join('pais', 'pais.id', 'departamentos.idPais')
        ->where('estudiante.id', $id)
