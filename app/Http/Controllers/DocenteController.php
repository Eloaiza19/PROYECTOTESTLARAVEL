...
class DocenteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('docente.index', compact('datosdocente')); //
    }
    ...
    public function store(storeDocenteRequest $request)
    {
        ...
        if($request->hasFile('imagen')){
            $datosdocente->imagen = $request->file('imagen')->store('public/docente/imagenes');
        }
        if($request->hasFile('documento')){
            $datosdocente->documento = $request->file('documento')->store('public/docente/documentos');
        }
        $datosdocente->save();
    ...
    public function show($id)
    {
        ...
        return view('docente.show', compact('datosdocente'));//
    }
    ...
    {
        $datosdocente = Docente::find($id);
        return view('docente.edit', compact('datosdocente')); //
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('imagen')){
            $datosdocente->imagen = $request->file('imagen')->store('public/docente');
        }
        $datosdocente->fill($request->except('documento'));
        if($request->hasFile('documento')){
            $datosdocente->documento = $request->file('documento')->store('public/docente');
        }
        $datosdocente->save();
